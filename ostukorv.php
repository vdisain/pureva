    ...
    <div class="d-flex flex-column flex-lg-row">
                        ...
                        <?php for ($i = 0; $i < 4; $i++): ?>
                            <tr class="bg-white">
                                <td class="product-thumbnail">
                                    <a href="#">
                                        <img class="checkout-thumbnail" src="/images/single-product-image.png" width="98"
                                            alt="product-name">
                                    </a>
                                </td>
                                <td class="product-name">
                                    <a class="txt-black fw-500 fs-16 mb-2" href="" #>Jalgratta esituli RETRO 3xLED + COB,
                                        2XAA</a>
        ...
        <div class="col-12 col-lg-4 mt-3 mt-lg-0">
            ...
            <div class="bg-white p-3 p-lg-4 rounded-3">
                <p class="fs-14 mb-0"><a class="login color-blue" href="#" target="_blank">Logi sisse</a>, et saada
                    püsikliendi soodustust. Kui sul ei ole kasutajat, siis <a class="register color-blue" href="#"
                        target="_blank">registreeru siin</a></p>
            </div>
        </div>
